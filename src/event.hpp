...
public:
	...
	unsigned char get_aftertouch_value()
	{
		return second_parameter;
	}
	unsigned char get_status_byte() const
...
public:
	...
	unsigned char get_controller_value()
	{
		return second_parameter;
	}
	unsigned char get_status_byte() const
...
public:
	...
	unsigned char get_pitch_value_LSB()
	{
		return first_parameter;
	}
	unsigned char get_pitch_value_MSB()
	{
		return second_parameter;
	}
	unsigned char get_status_byte() const
...
{
public:
	sequence_number(unsigned char msb, unsigned char lsb)
	{
		MSB = msb;
		LSB = lsb;
	}	unsigned char get_type() const
...
class copyriht_notice : public ascii_text_meta_event
{
public:
	copyriht_notice(unsigned length, const unsigned char * const p)
		:ascii_text_meta_event(length, p)
	{
	}
	unsigned char get_type() const
...
{
public:
	midi_channel_prefix(unsigned char chan)
	{
		channel = chan;
	}
	unsigned char get_type() const
