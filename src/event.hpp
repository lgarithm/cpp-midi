...
public:
  ...
  void set_delta_time(unsigned dlt)
  {
    delta_time = dlt;
  }
...
public:
  ...
  unary_midi_event(unsigned char param, unsigned char chan): parameter(param), midi_event(chan) {}

  std::string to_text() const
  {
    return "unary midi event";
  }
  ...
  void set_parameter(unsigned char param)
  {
    parameter = param;
  }
...
public:
  ...
  binary_midi_event(unsigned char param1, unsigned char param2, unsigned char chan):
    first_parameter(param1), second_parameter(param2), midi_event(chan) {}

  std::string to_text() const
  {
    return "binary midi event";
  }
  ...
  void set_first_parameter(unsigned char param)
  {
    first_parameter = param;
  }

  void set_second_parameter(unsigned char param)
  {
    second_parameter = param;
  }
...
public:
  ...
  note_off(unsigned char note_number, unsigned char velocity, unsigned char channel)
  ...
  unsigned char get_note_number() const
  {
...
public:
  note_on(unsigned char note_number, unsigned char velocity)
    :binary_midi_event(note_number, velocity) {}
  note_on(unsigned char note_number, unsigned char velocity, unsigned char channel)
    :binary_midi_event(note_number, velocity, channel) {}
...
public:
  ...
  unsigned char get_aftertouch_value() const
  {
    return second_parameter;
  }
...
public:
  ...
  controller(unsigned char controller_number, unsigned char controller_value, unsigned char channel)
  ...
  unsigned char get_controller_number() const
  {
    return first_parameter;
  }

  unsigned char get_controller_value() const
  {
    return second_parameter;
  }
...
public:
  ...
  unsigned char get_program_number() const
  {
    return parameter;
  }
...
public:
  ...
  unsigned char get_pitch_value_LSB() const
  {
    return first_parameter;
  }

  unsigned char get_pitch_value_MSB() const
  {
    return second_parameter;
  }
...
{
public:
  sysex_event(unsigned char status_byte,
	      unsigned length, const unsigned char * const p):
...
{
public:
  unknown_meta_event(unsigned char type, unsigned length, const unsigned char * const p):
...
{
public:
  time_signature(unsigned char n, unsigned char d, unsigned char m, unsigned char _32):
    numer(n),
    denom(d),
    metro(m),
    _32nds(_32){}
